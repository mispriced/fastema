...
hidden if the `fastema_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `fastema_DEVELOPER_MODE` to the configure
...
the operating system you have, which may be `linux` or `darwin`. You
